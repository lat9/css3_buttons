...
if (!defined ('CSS3_BUTTONS_INCLUDE_FONT_AWESOME')) {
  ...
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Submit-botton HTML Tag', 'CSS3_BUTTONS_SUBMIT_TYPE', 'input', 'Identify the type of HTML tag to use for CSS-generated submit buttone, either <em>input</em> (default) or <em>button</em>.  Please note that the <em>button</em> tag is not fully supported on older browsers.', 19, 150, NULL , 'zen_cfg_select_option(array(\'button\', \'input\'),')");
 
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ) VALUES ( 'Font-awesome version number', 'CSS3_BUTTONS_FONT_AWESOME_VERSION', '4.2.0', 'Enter the font-awesome version number to load, if the previous setting is set to <em>true</em>. Default: 4.2.0', 19, 152, NULL, NULL)");
